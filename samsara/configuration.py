...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of samsara.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the samsara.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = samsara.Configuration(
        signing_info = samsara.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://api.samsara.com",
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'Authorization: Bearer' in self.api_key:
            auth['AccessTokenHeader'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Authorization: Bearer',
                'value': self.get_api_key_with_prefix('Authorization: Bearer')
            }
        if 'access_token' in self.api_key:
            auth['AccessTokenParameter'] = {
                'type': 'api_key',
                'in': 'query',
                'key': 'access_token',
