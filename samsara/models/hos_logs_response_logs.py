...
class HosLogsResponseLogs(object):
    ...
    """
    def __init__(self, group_id=None, vehicle_id=None, driver_id=None, log_start_ms=None, status_type=None, loc_city=None, loc_state=None, loc_lat=None, loc_lng=None, loc_name=None):
        """
