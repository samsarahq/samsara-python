...
class VehicleStatsFaultCodesOBDII(object):
    ...
    openapi_types = {
        ...
        'diagnostic_trouble_codes': 'list[VehicleStatsFaultCodesOBDIITroubleCode]'
    }
    ...
    def __init__(self, check_engine_light_is_on=None, diagnostic_trouble_codes=None, local_vars_configuration=None):  # noqa: E501
        """VehicleStatsFaultCodesOBDII - a model defined in OpenAPI"""  # noqa: E501
    ...
    def check_engine_light_is_on(self):
        """Gets the check_engine_light_is_on of this VehicleStatsFaultCodesOBDII.  # noqa: E501

        True if the check engine light is illuminated (MIL status field is nonzero for any faults).  # noqa: E501

        :return: The check_engine_light_is_on of this VehicleStatsFaultCodesOBDII.  # noqa: E501
        :rtype: bool
        """
    ...
    def check_engine_light_is_on(self, check_engine_light_is_on):
        """Sets the check_engine_light_is_on of this VehicleStatsFaultCodesOBDII.

        True if the check engine light is illuminated (MIL status field is nonzero for any faults).  # noqa: E501

        :param check_engine_light_is_on: The check_engine_light_is_on of this VehicleStatsFaultCodesOBDII.  # noqa: E501
        :type: bool
        """
    ...
    def diagnostic_trouble_codes(self):
        """Gets the diagnostic_trouble_codes of this VehicleStatsFaultCodesOBDII.  # noqa: E501

        Diagnostic trouble codes for passenger vehicles.  # noqa: E501

        :return: The diagnostic_trouble_codes of this VehicleStatsFaultCodesOBDII.  # noqa: E501
        :rtype: list[VehicleStatsFaultCodesOBDIITroubleCode]
        """
    ...
    def diagnostic_trouble_codes(self, diagnostic_trouble_codes):
        """Sets the diagnostic_trouble_codes of this VehicleStatsFaultCodesOBDII.

        Diagnostic trouble codes for passenger vehicles.  # noqa: E501

        :param diagnostic_trouble_codes: The diagnostic_trouble_codes of this VehicleStatsFaultCodesOBDII.  # noqa: E501
        :type: list[VehicleStatsFaultCodesOBDIITroubleCode]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VehicleStatsFaultCodesOBDII):
            return False
