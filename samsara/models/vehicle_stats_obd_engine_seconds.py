...
class VehicleStatsObdEngineSeconds(object):
    ...
    def __init__(self, time=None, value=None, local_vars_configuration=None):  # noqa: E501
        """VehicleStatsObdEngineSeconds - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def time(self):
        """Gets the time of this VehicleStatsObdEngineSeconds.  # noqa: E501

        UTC timestamp in RFC 3339 format. Example: `2020-01-27T07:06:25Z`.  # noqa: E501

        :return: The time of this VehicleStatsObdEngineSeconds.  # noqa: E501
        :rtype: datetime
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this VehicleStatsObdEngineSeconds.

        UTC timestamp in RFC 3339 format. Example: `2020-01-27T07:06:25Z`.  # noqa: E501

        :param time: The time of this VehicleStatsObdEngineSeconds.  # noqa: E501
        :type: datetime
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VehicleStatsObdEngineSeconds):
            return False
