# samsara
This is a test README as an example of a custom template.
...
*SamsaraApi* | [**delete_carrier_proposed_assignment_by_id**](docs/SamsaraApi.md#delete_carrier_proposed_assignment_by_id) | **DELETE** /fleet/carrier-proposed-assignments/{id} | Delete an assignment
...
*SamsaraApi* | [**get_carrier_proposed_assignment**](docs/SamsaraApi.md#get_carrier_proposed_assignment) | **GET** /fleet/carrier-proposed-assignments | Retrieve assignments
...
*SamsaraApi* | [**list_drivers**](docs/SamsaraApi.md#list_drivers) | **GET** /fleet/drivers | List all drivers test
