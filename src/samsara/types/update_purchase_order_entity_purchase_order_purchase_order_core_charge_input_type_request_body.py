...
class UpdatePurchaseOrderEntityPurchaseOrderPurchaseOrderCoreChargeInputTypeRequestBody(UniversalBaseModel):
    ...
    recoverability_policy: typing_extensions.Annotated[
        typing.Optional[UpdatePurchaseOrderEntityPurchaseOrderCoreRecoverabilityPolicyInputTypeRequestBody],
    ...
    unit_core_amount: typing_extensions.Annotated[
        typing.Optional[UpdatePurchaseOrderEntityPurchaseOrderMoneyInputTypeRequestBody],
