...
class IftaDetailJobResponseBody(UniversalBaseModel):
    ...
    completed_at_time: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="completedAtTime", description=" The time this job completed successfully."),
    ] = None
    ...
    failed_at_time: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="failedAtTime"),
        pydantic.Field(alias="failedAtTime", description=" The time this job failed."),
    ] = None
    ...
    job_id: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="jobId", description=" The ID used to retrieve this job."),
    ]
    ...
    requested_at_time: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="requestedAtTime", description=" The time this job was requested for creation."),
    ]
    started_at_time: typing_extensions.Annotated[
        typing.Optional[str],
        FieldMetadata(alias="startedAtTime"),
        pydantic.Field(alias="startedAtTime", description=" The time this job started processing."),
    ] = None
