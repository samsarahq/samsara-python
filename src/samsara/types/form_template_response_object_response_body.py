...
class FormTemplateResponseObjectResponseBody(UniversalBaseModel):
    ...
    approval_config: typing_extensions.Annotated[
        typing.Optional[FormsApprovalConfigObjectResponseBody],
        FieldMetadata(alias="approvalConfig"),
    ...
    created_at_time: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="createdAtTime", description="Creation time of the form template. UTC timestamp in RFC 3339 format."
        ),
    ]
    ...
    form_category: typing_extensions.Annotated[
        typing.Optional[FormTemplateResponseObjectResponseBodyFormCategory],
        FieldMetadata(alias="formCategory"),
        pydantic.Field(
            alias="formCategory",
            description="Category of the form template.  Valid values: `general`, `routing`, `fuel`, `safety`, `assetInspection`",
        ),
    ] = None
    ...
    revision_id: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="revisionId", description="Unique identifier of the form template revision."),
    ]
    ...
    updated_at_time: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="updatedAtTime", description="Update time of the form template. UTC timestamp in RFC 3339 format."
        ),
    ]
