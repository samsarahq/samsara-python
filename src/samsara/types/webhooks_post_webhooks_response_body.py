...
class WebhooksPostWebhooksResponseBody(UniversalBaseModel):
    ...
    event_types: typing_extensions.Annotated[
        typing.Optional[typing.List[WebhooksPostWebhooksResponseBodyEventTypesItem]], FieldMetadata(alias="eventTypes")
    ] = pydantic.Field(default=None)
    """
    ...
    version: WebhooksPostWebhooksResponseBodyVersion = pydantic.Field()
    """
