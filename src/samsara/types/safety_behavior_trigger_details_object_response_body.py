...
class SafetyBehaviorTriggerDetailsObjectResponseBody(UniversalBaseModel):
    """
    ...
    statuses: typing.Optional[typing.List[SafetyBehaviorTriggerDetailsObjectResponseBodyStatusesItem]] = pydantic.Field(
        default=None
    )
    """
