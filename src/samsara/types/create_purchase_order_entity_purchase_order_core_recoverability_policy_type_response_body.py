...
from .create_purchase_order_entity_purchase_order_core_recoverability_policy_type_response_body_policy_type import (
...
class CreatePurchaseOrderEntityPurchaseOrderCoreRecoverabilityPolicyTypeResponseBody(UniversalBaseModel):
    ...
    policy_type: typing_extensions.Annotated[
        typing.Optional[CreatePurchaseOrderEntityPurchaseOrderCoreRecoverabilityPolicyTypeResponseBodyPolicyType],
