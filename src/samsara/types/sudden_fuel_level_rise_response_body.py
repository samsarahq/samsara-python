...
class SuddenFuelLevelRiseResponseBody(UniversalBaseModel):
    ...
    fuel_level_after_millipercent: typing_extensions.Annotated[
        ...
        pydantic.Field(
            ...
            description="The fuel level after the sudden fuel level rise in millipercents.",
        ),
    ] = None
    fuel_level_before_millipercent: typing_extensions.Annotated[
        ...
        pydantic.Field(
            ...
            description="The fuel level before the sudden fuel level rise in millipercents.",
        ),
    ] = None
