...
from .fuel_level_trigger_details_object_request_body_operation import FuelLevelTriggerDetailsObjectRequestBodyOperation


class FuelLevelTriggerDetailsObjectRequestBody(UniversalBaseModel):
    """
