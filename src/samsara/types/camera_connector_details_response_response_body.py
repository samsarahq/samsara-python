...
class CameraConnectorDetailsResponseResponseBody(UniversalBaseModel):
    """
    ...
    vehicle_gateway_serial: typing_extensions.Annotated[
        ...
        pydantic.Field(
            ...
            description="The serial number of the vehicle gateway that the camera connector is connected to.",
        ),
    ] = None
