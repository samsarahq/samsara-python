...
from .dvir_defect_get_defect_response_body_defect_safety_status import DvirDefectGetDefectResponseBodyDefectSafetyStatus
...
class DvirDefectGetDefectResponseBody(UniversalBaseModel):
    ...
    defect_safety_status: typing_extensions.Annotated[
        typing.Optional[DvirDefectGetDefectResponseBodyDefectSafetyStatus],
