...
from .work_order_with_time_entries_object_response_body_status import WorkOrderWithTimeEntriesObjectResponseBodyStatus


class WorkOrderWithTimeEntriesObjectResponseBody(UniversalBaseModel):
    """
    A work order object.
    """
    ...
    priority: typing.Optional[WorkOrderWithTimeEntriesObjectResponseBodyPriority] = pydantic.Field(default=None)
    """
    The priority of the work order  Valid values: `High`, `Low`, `Medium`, `Urgent`
    """

    service_task_instances: typing_extensions.Annotated[
        typing.Optional[typing.List[ServiceTaskInstanceWithTimeEntriesObjectResponseBody]],
    ...
    status: WorkOrderWithTimeEntriesObjectResponseBodyStatus = pydantic.Field()
    """
