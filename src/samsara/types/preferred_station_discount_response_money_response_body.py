...
class PreferredStationDiscountResponseMoneyResponseBody(UniversalBaseModel):
    """
    The discount value.
    """
    ...
    currency: PreferredStationDiscountResponseMoneyResponseBodyCurrency = pydantic.Field()
    """
