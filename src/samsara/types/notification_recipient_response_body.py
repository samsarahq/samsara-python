...
class NotificationRecipientResponseBody(UniversalBaseModel):
    """
    A user to notify about recovery state changes.
    """

    notification_types: typing.List[NotificationRecipientResponseBodyNotificationTypesItem] = pydantic.Field()
    """
