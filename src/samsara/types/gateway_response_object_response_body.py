...
class GatewayResponseObjectResponseBody(UniversalBaseModel):
    accessory_devices: typing_extensions.Annotated[
        typing.Optional[typing.List[AccessoryResponseObjectResponseBody]],
        FieldMetadata(alias="accessoryDevices"),
        pydantic.Field(alias="accessoryDevices", description="Accessory devices on gateway"),
    ] = None
    asset: typing.Optional[GatewayAssetResponseObjectResponseBody] = None
    connection_status: typing_extensions.Annotated[
        typing.Optional[ConnectionStatusResponseObjectResponseBody],
    ...
    data_usage_last_30_days: typing_extensions.Annotated[
        typing.Optional[DataUsageResponseObjectResponseBody],
        FieldMetadata(alias="dataUsageLast30Days"),
