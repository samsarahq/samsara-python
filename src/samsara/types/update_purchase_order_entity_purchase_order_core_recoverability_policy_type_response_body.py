...
from .update_purchase_order_entity_purchase_order_core_recoverability_policy_type_response_body_policy_type import (
...
class UpdatePurchaseOrderEntityPurchaseOrderCoreRecoverabilityPolicyTypeResponseBody(UniversalBaseModel):
    ...
    policy_type: typing_extensions.Annotated[
        typing.Optional[UpdatePurchaseOrderEntityPurchaseOrderCoreRecoverabilityPolicyTypeResponseBodyPolicyType],
