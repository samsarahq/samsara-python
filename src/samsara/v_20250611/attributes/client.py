...
class AsyncAttributesClient:
    ...
    async def get_attributes_by_entity_type(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.attributes.get_attributes_by_entity_type(
                entity_type="driver",
                limit=1000000,
                after="after",
            )
    ...
    async def create_attribute(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.attributes.create_attribute(
                attribute_type="single-select",
                entity_type="driver",
                name="License Certifications",
            )
    ...
    async def get_attribute(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.attributes.get_attribute(
                id="id",
                entity_type="driver",
            )
    ...
    async def delete_attribute(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.attributes.delete_attribute(
                id="id",
                entity_type="driver",
            )
    ...
    async def update_attribute(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.attributes.update_attribute(
                id="id",
                entity_type="driver",
            )
