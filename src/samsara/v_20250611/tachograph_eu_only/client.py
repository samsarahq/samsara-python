...
class AsyncTachographEuOnlyClient:
    ...
    async def get_driver_tachograph_activity(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.tachograph_eu_only.get_driver_tachograph_activity(
                after="after",
                start_time="startTime",
                end_time="endTime",
            )
    ...
    async def get_driver_tachograph_files(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.tachograph_eu_only.get_driver_tachograph_files(
                after="after",
                start_time="startTime",
                end_time="endTime",
            )
    ...
    async def get_vehicle_tachograph_files(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.tachograph_eu_only.get_vehicle_tachograph_files(
                after="after",
                start_time="startTime",
                end_time="endTime",
            )
