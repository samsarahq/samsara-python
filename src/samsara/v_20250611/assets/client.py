...
class AsyncAssetsClient:
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            response = await client.v_20250611.assets.list(
                type="uncategorized",
                after="after",
                updated_after_time="updatedAfterTime",
                include_external_ids=True,
    ...
    async def create_asset(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.assets.create_asset()
    ...
    async def delete_asset(self, *, id: str, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        async def main() -> None:
            await client.v_20250611.assets.delete_asset(
                id="id",
            )
    ...
    async def update_asset(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.assets.update_asset(
                id="id",
            )
    ...
    async def v_1_get_all_asset_current_locations(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.assets.v_1_get_all_asset_current_locations(
                starting_after="startingAfter",
                ending_before="endingBefore",
                limit=1000000,
            )
    ...
    async def v_1_get_assets_reefers(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.assets.v_1_get_assets_reefers(
                start_ms=1000000,
                end_ms=1000000,
                starting_after="startingAfter",
                ending_before="endingBefore",
    ...
    async def v_1_get_asset_location(
        ...
        async def main() -> None:
            await client.v_20250611.assets.v_1_get_asset_location(
                asset_id=1000000,
                start_ms=1000000,
                end_ms=1000000,
            )
    ...
    async def v_1_get_asset_reefer(
        ...
        async def main() -> None:
            await client.v_20250611.assets.v_1_get_asset_reefer(
                asset_id=1000000,
                start_ms=1000000,
                end_ms=1000000,
            )
    ...
    async def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        async def main() -> None:
            await client.v_20250611.assets.get(
                id="id",
            )
    ...
    async def update(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        async def main() -> None:
            await client.v_20250611.assets.update(
                id="id",
            )
