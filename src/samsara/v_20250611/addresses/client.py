    ...
    def create(
        ...
        *,
        ...
        address_types : typing.Optional[typing.Sequence[CreateAddressRequestAddressTypesItem]]
            Reporting location type associated with the address (used for ELD reporting purposes). Valid values: `yard`, `shortHaul`, `workforceSite`, `riskZone`, `industrialSite`, `alertsOnly`, `agricultureSource`, `avoidanceZone`.
...
class AsyncAddressesClient:
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            response = await client.v_20250611.addresses.list(
                limit=1000000,
                after="after",
                created_after_time="createdAfterTime",
            )
    ...
    async def create(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.addresses.create(
                formatted_address="350 Rhode Island St, San Francisco, CA",
                geofence=CreateAddressRequestGeofence(),
                name="Samsara HQ",
            )
    ...
    async def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> AddressResponse:
        ...
        async def main() -> None:
            await client.v_20250611.addresses.get(
                id="id",
            )
    ...
    async def delete(
        ...
        async def main() -> None:
            await client.v_20250611.addresses.delete(
                id="id",
            )
    ...
    async def update(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.addresses.update(
                id="id",
            )
