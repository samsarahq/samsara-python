...
class AsyncIndustrialClient:
    ...
    async def get_industrial_assets(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.industrial.get_industrial_assets(
                limit=1000000,
                after="after",
            )
    ...
    async def create_industrial_asset(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.industrial.create_industrial_asset(
                name="name",
            )
    ...
    async def delete_industrial_asset(
        ...
        async def main() -> None:
            await client.v_20250611.industrial.delete_industrial_asset(
                id="id",
            )
    ...
    async def patch_industrial_asset(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.industrial.patch_industrial_asset(
                id="id",
            )
    ...
    async def patch_asset_data_outputs(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.industrial.patch_asset_data_outputs(
                id="id",
                values={"key": "value"},
            )
    ...
    async def get_data_inputs(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.industrial.get_data_inputs(
                limit=1000000,
                after="after",
            )
    ...
    async def get_data_input_data_snapshot(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.industrial.get_data_input_data_snapshot(
                after="after",
            )
    ...
    async def get_data_input_data_feed(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.industrial.get_data_input_data_feed(
                after="after",
            )
    ...
    async def get_data_input_data_history(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.industrial.get_data_input_data_history(
                start_time="startTime",
                end_time="endTime",
                after="after",
            )
    ...
    async def v_1_get_cameras(
        ...
        async def main() -> None:
            await client.v_20250611.industrial.v_1_get_cameras()
    ...
    async def v_1_get_vision_programs_by_camera(
        ...
        async def main() -> None:
            await client.v_20250611.industrial.v_1_get_vision_programs_by_camera(
                camera_id=1000000,
            )
    ...
    async def v_1_get_vision_latest_run_camera(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.industrial.v_1_get_vision_latest_run_camera(
                camera_id=1000000,
                program_id=1000000,
                started_at_ms=1000000,
                include="include",
    ...
    async def v_1_get_vision_runs(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.industrial.v_1_get_vision_runs(
                duration_ms=1000000,
                end_ms=1000000,
            )
    ...
    async def get_vision_runs_by_camera(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.industrial.get_vision_runs_by_camera(
                camera_id=1000000,
                duration_ms=1000000,
                end_ms=1000000,
            )
    ...
    async def v_1_get_vision_runs_by_camera_and_program(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.industrial.v_1_get_vision_runs_by_camera_and_program(
                camera_id=1000000,
                program_id=1000000,
                started_at_ms=1000000,
                include="include",
    ...
    async def v_1_get_machines_history(
        ...
        async def main() -> None:
            await client.v_20250611.industrial.v_1_get_machines_history(
                end_ms=1462881998034,
                start_ms=1462878398034,
            )
    ...
    async def v_1_get_machines(self, *, request_options: typing.Optional[RequestOptions] = None) -> InlineResponse2008:
        ...
        async def main() -> None:
            await client.v_20250611.industrial.v_1_get_machines()
