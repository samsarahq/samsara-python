...
class AsyncCoachingClient:
    ...
    async def get_driver_coach_assignment(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.coaching.get_driver_coach_assignment(
                include_external_ids=True,
                after="after",
            )
    ...
    async def put_driver_coach_assignment(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.coaching.put_driver_coach_assignment(
                driver_id="driverId",
                coach_id="coachId",
            )
    ...
    async def get_coaching_sessions(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.coaching.get_coaching_sessions(
                include_coachable_events=True,
                start_time=datetime.datetime.fromisoformat(
                    "2024-01-15 09:30:00+00:00",
                ),
