...
class AsyncHubsClient:
    ...
    async def list_hub_capacities(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.hubs.list_hub_capacities(
                hub_id="hubId",
                capacity_ids="capacityIds",
                capacity_names="capacityNames",
                start_time=datetime.datetime.fromisoformat(
    ...
    async def update_hub_location(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.hubs.update_hub_location(
                id="id",
                data=UpdateHubLocationRequestBodyRequestBody(
                    address="123 Industrial Blvd, Los Angeles, CA 90210, US",
                    customer_location_id="LOC-123",
    ...
    async def list_hub_locations(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.hubs.list_hub_locations(
                hub_id="hubId",
                location_ids="locationIds",
                customer_location_ids="customerLocationIds",
                start_time=datetime.datetime.fromisoformat(
    ...
    async def create_hub_locations(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.hubs.create_hub_locations(
                data=[
                    HubLocationInputObjectRequestBody(
                        address="123 Industrial Blvd, Los Angeles, CA 90210, US",
                        customer_location_id="LOC-123",
    ...
    async def list_hub_skills(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.hubs.list_hub_skills(
                hub_id="hubId",
                skill_ids="skillIds",
                skill_names="skillNames",
                start_time=datetime.datetime.fromisoformat(
    ...
    async def list_hubs(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.hubs.list_hubs(
                hub_ids="hubIds",
                start_time=datetime.datetime.fromisoformat(
                    "2024-01-15 09:30:00+00:00",
                ),
