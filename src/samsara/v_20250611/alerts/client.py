...
class AsyncAlertsClient:
    ...
    async def get_configurations(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.alerts.get_configurations(
                status="all",
                after="after",
                include_external_ids=True,
            )
    ...
    async def post_configurations(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.alerts.post_configurations(
                actions=[
                    ActionObjectRequestBody(
                        action_type_id=1,
                    )
    ...
    async def delete_configurations(self, *, id: str, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        async def main() -> None:
            await client.v_20250611.alerts.delete_configurations(
                id="id",
            )
    ...
    async def patch_configurations(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.alerts.patch_configurations(
                id="e1c5dffc-c7b7-47b0-a778-6a65de638abf",
            )
    ...
    async def get_incidents(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.alerts.get_incidents(
                start_time="startTime",
            )
