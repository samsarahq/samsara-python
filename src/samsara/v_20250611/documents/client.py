...
class AsyncDocumentsClient:
    ...
    async def get_document_types(
        ...
        async def main() -> None:
            await client.v_20250611.documents.get_document_types(
                after="after",
            )
    ...
    async def get_documents(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.documents.get_documents(
                start_time="startTime",
                end_time="endTime",
                after="after",
                document_type_id="documentTypeId",
    ...
    async def post_document(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.documents.post_document(
                document_type_id="9814a1fa-f0c6-408b-bf85-51dc3bc71ac7",
                driver_id="45646",
            )
    ...
    async def generate_document_pdf(
        ...
        async def main() -> None:
            await client.v_20250611.documents.generate_document_pdf(
                document_id="6c8c0c01-206a-41a4-9d21-15b9978d04cb",
            )
    ...
    async def get_document_pdf(
        ...
        async def main() -> None:
            await client.v_20250611.documents.get_document_pdf(
                id="id",
            )
    ...
    async def get_document(
        ...
        async def main() -> None:
            await client.v_20250611.documents.get_document(
                id="id",
            )
    ...
    async def delete_document(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        async def main() -> None:
            await client.v_20250611.documents.delete_document(
                id="id",
            )
