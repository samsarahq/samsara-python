...
class AsyncFormsClient:
    ...
    async def get_form_submissions(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.forms.get_form_submissions()
    ...
    async def post_form_submission(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.forms.post_form_submission(
                form_template=FormTemplateRequestObjectRequestBody(
                    id="9814a1fa-f0c6-408b-bf85-51dc3bc71ac7",
                    revision_id="1214a1fa-f0c6-408b-bf85-51dc3bc71ac7",
                ),
    ...
    async def patch_form_submission(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.forms.patch_form_submission(
                id="9814a1fa-f0c6-408b-bf85-51dc3bc71ac8",
                status="notStarted",
            )
    ...
    async def get_form_submissions_pdf_exports(
        ...
        async def main() -> None:
            await client.v_20250611.forms.get_form_submissions_pdf_exports(
                pdf_id="pdfId",
            )
    ...
    async def post_form_submissions_pdf_exports(
        ...
        async def main() -> None:
            await client.v_20250611.forms.post_form_submissions_pdf_exports(
                id="id",
            )
    ...
    async def get_form_submissions_stream(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.forms.get_form_submissions_stream(
                start_time="startTime",
                end_time="endTime",
                after="after",
            )
    ...
    async def get_form_templates(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.forms.get_form_templates(
                after="after",
            )
