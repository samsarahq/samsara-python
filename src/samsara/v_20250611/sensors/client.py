...
class AsyncSensorsClient:
    ...
    async def v_1_get_sensors_cargo(
        ...
        async def main() -> None:
            await client.v_20250611.sensors.v_1_get_sensors_cargo(
                sensors=[122],
            )
    ...
    async def v_1_get_sensors_door(
        ...
        async def main() -> None:
            await client.v_20250611.sensors.v_1_get_sensors_door(
                sensors=[122],
            )
    ...
    async def v_1_get_sensors_history(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.sensors.v_1_get_sensors_history(
                end_ms=1462881998034,
                series=[
                    V1SensorsHistorySeries(
                        field="ambientTemperature",
    ...
    async def v_1_get_sensors_humidity(
        ...
        async def main() -> None:
            await client.v_20250611.sensors.v_1_get_sensors_humidity(
                sensors=[122],
            )
    ...
    async def v_1_get_sensors(self, *, request_options: typing.Optional[RequestOptions] = None) -> InlineResponse2009:
        ...
        async def main() -> None:
            await client.v_20250611.sensors.v_1_get_sensors()
    ...
    async def v_1_get_sensors_temperature(
        ...
        async def main() -> None:
            await client.v_20250611.sensors.v_1_get_sensors_temperature(
                sensors=[122],
            )
