...
class AsyncContactsClient:
    ...
    async def list_contacts(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.contacts.list_contacts(
                limit=1000000,
                after="after",
            )
    ...
    async def create_contact(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.contacts.create_contact()
    ...
    async def get_contact(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> ContactResponse:
        ...
        async def main() -> None:
            await client.v_20250611.contacts.get_contact(
                id="id",
            )
    ...
    async def delete_contact(
        ...
        async def main() -> None:
            await client.v_20250611.contacts.delete_contact(
                id="id",
            )
    ...
    async def update_contact(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.contacts.update_contact(
                id="id",
            )
