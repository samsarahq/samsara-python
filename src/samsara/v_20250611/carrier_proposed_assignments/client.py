...
class AsyncCarrierProposedAssignmentsClient:
    ...
    async def list_carrier_proposed_assignments(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.carrier_proposed_assignments.list_carrier_proposed_assignments(
                limit=1000000,
                after="after",
                active_time="activeTime",
            )
    ...
    async def create_carrier_proposed_assignment(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.carrier_proposed_assignments.create_carrier_proposed_assignment(
                driver_id="42",
                vehicle_id="123",
            )
    ...
    async def delete_carrier_proposed_assignment(
        ...
        async def main() -> None:
            await client.v_20250611.carrier_proposed_assignments.delete_carrier_proposed_assignment(
                id="id",
            )
