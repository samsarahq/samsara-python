...
class AsyncSafetyClient:
    ...
    async def get_safety_events(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.safety.get_safety_events(
                after="after",
                start_time="startTime",
                end_time="endTime",
            )
    ...
    async def get_safety_activity_event_feed(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.safety.get_safety_activity_event_feed(
                after="after",
                start_time="startTime",
            )
    ...
    async def v_1_get_driver_safety_score(
        ...
        async def main() -> None:
            await client.v_20250611.safety.v_1_get_driver_safety_score(
                driver_id=1000000,
                start_ms=1000000,
                end_ms=1000000,
            )
    ...
    async def v_1_get_vehicle_harsh_event(
        ...
        async def main() -> None:
            await client.v_20250611.safety.v_1_get_vehicle_harsh_event(
                vehicle_id=1000000,
                timestamp=1000000,
            )
    ...
    async def v_1_get_vehicle_safety_score(
        ...
        async def main() -> None:
            await client.v_20250611.safety.v_1_get_vehicle_safety_score(
                vehicle_id=1000000,
                start_ms=1000000,
                end_ms=1000000,
            )
