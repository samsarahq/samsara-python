...
class AsyncRoutesClient:
    ...
    async def fetch_routes(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.routes.fetch_routes(
                start_time="startTime",
                end_time="endTime",
                limit=1,
                after="after",
    ...
    async def create_route(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.routes.create_route(
                name="Bid 123",
                stops=[CreateRoutesStopRequestObjectRequestBody()],
            )
    ...
    async def get_routes_feed(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.routes.get_routes_feed(
                after="after",
            )
    ...
    async def fetch_route(
        ...
        async def main() -> None:
            await client.v_20250611.routes.fetch_route(
                id="id",
            )
    ...
    async def delete_route(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        async def main() -> None:
            await client.v_20250611.routes.delete_route(
                id="id",
            )
    ...
    async def patch_route(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.routes.patch_route(
                id="id",
            )
    ...
    async def list_hub_plan_routes(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.routes.list_hub_plan_routes(
                plan_id="planId",
                route_ids="routeIds",
                start_time=datetime.datetime.fromisoformat(
                    "2024-01-15 09:30:00+00:00",
    ...
    async def v_1_delete_dispatch_route_by_id(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.routes.v_1_delete_dispatch_route_by_id(
                route_id_or_external_id="route_id_or_external_id",
            )
