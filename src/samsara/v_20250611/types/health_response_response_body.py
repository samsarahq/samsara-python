...
class HealthResponseResponseBody(UniversalBaseModel):
    ...
    * `recommendedActionCcHealthy`: Camera connector is healthy. No action required.
    * `recommendedActionCcLowUptime`: Please ensure all cameras are physically connected to the camera connector.
    * `recommendedActionCcMediaInputUptime`: Please ensure the camera is properly connected to the camera connector.
    ...
    * `recommendedActionCruxHealthy`: Device is healthy. No action required.
    * `recommendedActionCruxLowBattery`: The device battery is low. Please contact support.
