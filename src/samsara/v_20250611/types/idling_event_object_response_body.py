...
class IdlingEventObjectResponseBody(UniversalBaseModel):
    ...
    """
    The type of the geofence address of the idling location, if applicable.  Valid values: `agricultureSource`, `alertsOnly`, `avoidanceZone`, `industrialSite`, `riskZone`, `shortHaul`, `undefined`, `workforceSite`, `yard`
    """
