...
class AsyncMaintenanceClient:
    ...
    async def get_defect_types(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.maintenance.get_defect_types(
                after="after",
                limit=1,
            )
    ...
    async def stream_defects(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.maintenance.stream_defects(
                after="after",
                limit=1,
                start_time="startTime",
                end_time="endTime",
    ...
    async def get_defect(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.maintenance.get_defect(
                id="id",
                include_external_ids=True,
            )
    ...
    async def get_dvirs(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.maintenance.get_dvirs(
                after="after",
                limit=1,
                include_external_ids=True,
                start_time="startTime",
    ...
    async def get_dvir(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.maintenance.get_dvir(
                id="id",
                include_external_ids=True,
            )
    ...
    async def update_dvir_defect(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.maintenance.update_dvir_defect(
                id="id",
            )
    ...
    async def create_dvir(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.maintenance.create_dvir(
                author_id="11",
                safety_status="safe",
            )
    ...
    async def update_dvir(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.maintenance.update_dvir(
                id="id",
                author_id="11",
                is_resolved=True,
            )
    ...
    async def v_1_get_fleet_maintenance_list(
        ...
        async def main() -> None:
            await client.v_20250611.maintenance.v_1_get_fleet_maintenance_list()
