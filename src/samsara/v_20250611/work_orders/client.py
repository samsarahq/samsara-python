...
class AsyncWorkOrdersClient:
    ...
    async def get_service_tasks(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.work_orders.get_service_tasks(
                include_archived=True,
                after="after",
            )
    ...
    async def get_work_orders(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.work_orders.get_work_orders(
                after="after",
            )
    ...
    async def post_work_orders(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.work_orders.post_work_orders(
                asset_id="12443",
            )
    ...
    async def delete_work_orders(self, *, id: str, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        async def main() -> None:
            await client.v_20250611.work_orders.delete_work_orders(
                id="id",
            )
    ...
    async def patch_work_orders(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.work_orders.patch_work_orders(
                id="5",
            )
    ...
    async def stream_work_orders(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.work_orders.stream_work_orders(
                after="after",
                start_time="startTime",
                end_time="endTime",
            )
