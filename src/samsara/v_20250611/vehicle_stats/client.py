...
from .raw_client import AsyncRawVehicleStatsClient, RawVehicleStatsClient
...
class VehicleStatsClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._raw_client = RawVehicleStatsClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> RawVehicleStatsClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        RawVehicleStatsClient
        """
    ...
    def get_vehicle_stats(
        ...
        *,
        ...
        """
        _response = self._raw_client.get_vehicle_stats(
            after=after,
            time=time,
    ...
    def get_vehicle_stats_feed(
        ...
        *,
        ...
        """
        _response = self._raw_client.get_vehicle_stats_feed(
            after=after,
            parent_tag_ids=parent_tag_ids,
            tag_ids=tag_ids,
            vehicle_ids=vehicle_ids,
    ...
    def get_vehicle_stats_history(
        ...
        *,
        ...
        """
        _response = self._raw_client.get_vehicle_stats_history(
...
class AsyncVehicleStatsClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._raw_client = AsyncRawVehicleStatsClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> AsyncRawVehicleStatsClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        AsyncRawVehicleStatsClient
        """
        return self._raw_client
    ...
    async def get_vehicle_stats(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.vehicle_stats.get_vehicle_stats()


        asyncio.run(main())
        """
        _response = await self._raw_client.get_vehicle_stats(
            after=after,
            time=time,
            parent_tag_ids=parent_tag_ids,
            tag_ids=tag_ids,
    ...
    async def get_vehicle_stats_feed(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.vehicle_stats.get_vehicle_stats_feed()


        asyncio.run(main())
        """
        _response = await self._raw_client.get_vehicle_stats_feed(
            after=after,
            parent_tag_ids=parent_tag_ids,
            tag_ids=tag_ids,
            vehicle_ids=vehicle_ids,
    ...
    async def get_vehicle_stats_history(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.vehicle_stats.get_vehicle_stats_history(
                start_time="startTime",
                end_time="endTime",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.get_vehicle_stats_history(
            start_time=start_time,
            end_time=end_time,
            after=after,
            parent_tag_ids=parent_tag_ids,
