...
class AsyncIftaClient:
    ...
    async def get_ifta_jurisdiction_reports(
        ...
        **Note:** The most recent 72 hours of data may still be processing and is subject to change and latency, so it is not recommended to request data for the most recent 72 hours.
        ...
        async def main() -> None:
            await client.v_20250611.ifta.get_ifta_jurisdiction_reports(
                year=1,
                month="January",
                quarter="Q1",
                jurisdictions="jurisdictions",
    ...
    async def get_ifta_vehicle_reports(
        ...
        **Note:** The most recent 72 hours of data may still be processing and is subject to change and latency, so it is not recommended to request data for the most recent 72 hours.
        ...
        async def main() -> None:
            await client.v_20250611.ifta.get_ifta_vehicle_reports(
                year=1,
                month="January",
                quarter="Q1",
                jurisdictions="jurisdictions",
    ...
    async def create_ifta_detail_job(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.ifta.create_ifta_detail_job(
                end_hour="2019-06-13T19:00:00Z",
                start_hour="2019-06-13T19:00:00Z",
            )
    ...
    async def get_ifta_detail_job(
        ...
        async def main() -> None:
            await client.v_20250611.ifta.get_ifta_detail_job(
                id="id",
            )
