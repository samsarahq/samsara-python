...
class AsyncLiveSharingLinksClient:
    ...
    async def get_live_sharing_links(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.live_sharing_links.get_live_sharing_links(
                type="all",
                limit=1,
                after="after",
            )
    ...
    async def create_live_sharing_link(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.live_sharing_links.create_live_sharing_link(
                name="Example Live Sharing Link name",
                type="assetsLocation",
            )
    ...
    async def delete_live_sharing_link(
        ...
        async def main() -> None:
            await client.v_20250611.live_sharing_links.delete_live_sharing_link(
                id="id",
            )
    ...
    async def update_live_sharing_link(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.live_sharing_links.update_live_sharing_link(
                id="id",
                name="Example Live Sharing Link name",
            )
