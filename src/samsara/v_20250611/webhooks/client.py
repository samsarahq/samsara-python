...
class AsyncWebhooksClient:
    ...
    async def list_webhooks(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.webhooks.list_webhooks(
                ids="ids",
                limit=1,
                after="after",
            )
    ...
    async def post_webhooks(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.webhooks.post_webhooks(
                name="Webhook-123",
                url="https://www.Webhook-123.com/webhook/listener",
            )
    ...
    async def get_webhook(
        ...
        async def main() -> None:
            await client.v_20250611.webhooks.get_webhook(
                id="id",
            )
    ...
    async def delete_webhook(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        async def main() -> None:
            await client.v_20250611.webhooks.delete_webhook(
                id="id",
            )
    ...
    async def patch_webhook(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.webhooks.patch_webhook(
                id="id",
            )
