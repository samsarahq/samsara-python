...
class AsyncSettingsClient:
    ...
    async def get_compliance_settings(
        ...
        async def main() -> None:
            await client.v_20250611.settings.get_compliance_settings()
    ...
    async def patch_compliance_settings(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.settings.patch_compliance_settings()
    ...
    async def get_driver_app_settings(
        ...
        async def main() -> None:
            await client.v_20250611.settings.get_driver_app_settings()
    ...
    async def patch_driver_app_settings(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.settings.patch_driver_app_settings()
    ...
    async def get_safety_settings(
        ...
        async def main() -> None:
            await client.v_20250611.settings.get_safety_settings()
