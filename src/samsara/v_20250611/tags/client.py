...
class AsyncTagsClient:
    ...
    async def list_tags(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.tags.list_tags(
                limit=1000000,
                after="after",
            )
    ...
    async def create_tag(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.tags.create_tag(
                name="California",
            )
    ...
    async def get_tag(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> TagResponse:
        ...
        async def main() -> None:
            await client.v_20250611.tags.get_tag(
                id="id",
            )
    ...
    async def replace_tag(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.tags.replace_tag(
                id="id",
            )
    ...
    async def delete_tag(
        ...
        async def main() -> None:
            await client.v_20250611.tags.delete_tag(
                id="id",
            )
    ...
    async def patch_tag(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.tags.patch_tag(
                id="id",
            )
