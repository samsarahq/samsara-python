...
class AsyncUsersClient:
    ...
    async def list_user_roles(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.users.list_user_roles(
                limit=1000000,
                after="after",
            )
    ...
    async def list_users(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.users.list_users(
                limit=1000000,
                after="after",
            )
    ...
    async def create_user(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.users.create_user(
                auth_type="default",
                email="user@company.com",
                name="Bob Smith",
                roles=[
    ...
    async def get_user(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> UserResponse:
        ...
        async def main() -> None:
            await client.v_20250611.users.get_user(
                id="id",
            )
    ...
    async def delete_user(
        ...
        async def main() -> None:
            await client.v_20250611.users.delete_user(
                id="id",
            )
    ...
    async def update_user(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.users.update_user(
                id="id",
            )
