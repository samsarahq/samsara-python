...
class AsyncTrailerAssignmentsClient:
    ...
    async def v_1_get_all_trailer_assignments(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.trailer_assignments.v_1_get_all_trailer_assignments(
                start_ms=1000000,
                end_ms=1000000,
                limit=1000000,
                starting_after="startingAfter",
    ...
    async def v_1_get_fleet_trailer_assignments(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.trailer_assignments.v_1_get_fleet_trailer_assignments(
                trailer_id=1000000,
                start_ms=1000000,
                end_ms=1000000,
            )
