...
class AsyncTrailersClient:
    ...
    async def list_trailers(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.trailers.list_trailers(
                tag_ids="tagIds",
                parent_tag_ids="parentTagIds",
                limit=1,
                after="after",
    ...
    async def create_trailer(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.trailers.create_trailer(
                name="Trailer-123",
            )
    ...
    async def get_trailer(
        ...
        async def main() -> None:
            await client.v_20250611.trailers.get_trailer(
                id="id",
            )
    ...
    async def delete_trailer(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        async def main() -> None:
            await client.v_20250611.trailers.delete_trailer(
                id="id",
            )
    ...
    async def update_trailer(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.trailers.update_trailer(
                id="id",
            )
