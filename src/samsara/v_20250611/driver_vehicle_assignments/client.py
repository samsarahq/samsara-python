...
class AsyncDriverVehicleAssignmentsClient:
    ...
    async def get_driver_vehicle_assignments(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.driver_vehicle_assignments.get_driver_vehicle_assignments(
                filter_by="drivers",
                start_time="startTime",
                end_time="endTime",
                driver_tag_ids="driverTagIds",
    ...
    async def create_driver_vehicle_assignment(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.driver_vehicle_assignments.create_driver_vehicle_assignment(
                driver_id="494123",
                vehicle_id="281474978683353",
            )
    ...
    async def delete_driver_vehicle_assignments(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.driver_vehicle_assignments.delete_driver_vehicle_assignments(
                vehicle_id="281474978683353",
            )
    ...
    async def update_driver_vehicle_assignment(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.driver_vehicle_assignments.update_driver_vehicle_assignment(
                driver_id="494123",
                start_time="2019-06-13T19:08:25Z",
                vehicle_id="281474978683353",
            )
