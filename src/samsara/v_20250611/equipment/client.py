...
class AsyncEquipmentClient:
    ...
    async def list_equipment(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.equipment.list_equipment(
                limit=1000000,
                after="after",
            )
    ...
    async def get_equipment_locations(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.equipment.get_equipment_locations(
                after="after",
            )
    ...
    async def get_equipment_locations_feed(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.equipment.get_equipment_locations_feed(
                after="after",
            )
    ...
    async def get_equipment_locations_history(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.equipment.get_equipment_locations_history(
                after="after",
                start_time="startTime",
                end_time="endTime",
            )
    ...
    async def get_equipment_stats(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.equipment.get_equipment_stats()
    ...
    async def get_equipment_stats_feed(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.equipment.get_equipment_stats_feed()
    ...
    async def get_equipment_stats_history(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.equipment.get_equipment_stats_history(
                start_time="startTime",
                end_time="endTime",
            )
    ...
    async def get_equipment(
        ...
        async def main() -> None:
            await client.v_20250611.equipment.get_equipment(
                id="id",
            )
