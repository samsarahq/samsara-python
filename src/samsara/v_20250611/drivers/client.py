...
class AsyncDriversClient:
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            response = await client.v_20250611.drivers.list(
                driver_activation_status="active",
                limit=1000000,
                after="after",
                updated_after_time="updatedAfterTime",
    ...
    async def create(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.drivers.create(
                name="Susan Jones",
                password="aSecurePassword1234",
                username="SusanJones",
            )
    ...
    async def post_driver_remote_signout(
        ...
        async def main() -> None:
            await client.v_20250611.drivers.post_driver_remote_signout(
                driver_id="12434",
            )
    ...
    async def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> DriverResponse:
        ...
        async def main() -> None:
            await client.v_20250611.drivers.get(
                id="id",
            )
    ...
    async def delete(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        async def main() -> None:
            await client.v_20250611.drivers.delete(
                id="id",
            )
    ...
    async def update(
        ...
        *,
        ...
        async def main() -> None:
            await client.v_20250611.drivers.update(
                id="id",
            )
