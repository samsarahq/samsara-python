...
class RawFleetClient:
    ...
    ) -> HttpResponse[FleetLocationsGetFleetLocationsResponseBody]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=FleetLocationsGetFleetLocationsResponseBody,  # type: ignore
...
class AsyncRawFleetClient:
    ...
    async def get_fleet_locations(
        ...
        *,
        ...
        tag_ids: typing.Optional[typing.Union[str, typing.Sequence[str]]] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[FleetLocationsGetFleetLocationsResponseBody]:
        """
        Get current location of vehicles.
