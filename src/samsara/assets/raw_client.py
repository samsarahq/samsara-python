...
from ..types.asset_locations_get_asset_location_response_body import AssetLocationsGetAssetLocationResponseBody
...
class RawAssetsClient:
    ...
    def get_asset_location(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[AssetLocationsGetAssetLocationResponseBody]:
        """
        <n class="warning">
        <nh>
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=AssetLocationsGetAssetLocationResponseBody,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    ) -> HttpResponse[AssetsGetAssetReeferResponseBody]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=AssetsGetAssetReeferResponseBody,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawAssetsClient:
    ...
    async def get_asset_location(
        ...
        *,
        ...
        end_ms: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[AssetLocationsGetAssetLocationResponseBody]:
        """
        <n class="warning">
        <nh>
        <i class="fa fa-exclamation-circle"></i>
    ...
    async def get_asset_reefer(
        self, asset_id: int, *, start_ms: int, end_ms: int, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[AssetsGetAssetReeferResponseBody]:
        """
        Fetch the reefer-specific stats of an asset.
