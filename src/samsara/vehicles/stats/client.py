...
class StatsClient:
    ...
    def feed(
        ...
        *,
        ...
        response = client.vehicles.stats.feed()
        for item in response:
            yield item
        # alternatively, you can paginate page-by-page
        for page in response.iter_pages():
    ...
    def history(
        ...
        *,
        ...
        response = client.vehicles.stats.history(
...
class AsyncStatsClient:
    ...
    async def feed(
        ...
        *,
        ...
        async def main() -> None:
            response = await client.vehicles.stats.feed()
            async for item in response:
                yield item
    ...
    async def history(
        ...
        *,
        ...
        async def main() -> None:
            response = await client.vehicles.stats.history(
                start_time="startTime",
                end_time="endTime",
            )
            async for item in response:
