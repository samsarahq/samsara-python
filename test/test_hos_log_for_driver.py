...
import samsara
from samsara.models.hos_log_for_driver import HosLogForDriver  # noqa: E501
from samsara.rest import ApiException

class TestHosLogForDriver(unittest.TestCase):
    """HosLogForDriver unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test HosLogForDriver
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = samsara.models.hos_log_for_driver.HosLogForDriver()  # noqa: E501
        if include_optional :
            return HosLogForDriver(
