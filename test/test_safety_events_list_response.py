...
import samsara
from samsara.models.safety_events_list_response import SafetyEventsListResponse  # noqa: E501
from samsara.rest import ApiException

class TestSafetyEventsListResponse(unittest.TestCase):
    """SafetyEventsListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SafetyEventsListResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = samsara.models.safety_events_list_response.SafetyEventsListResponse()  # noqa: E501
        if include_optional :
            return SafetyEventsListResponse(
                data = [
                    samsara.models.safety_event.SafetyEvent(
                        behavior_labels = [
    ...
    def testSafetyEventsListResponse(self):
        """Test SafetyEventsListResponse"""
