...
import samsara
from samsara.models.create_driver_request import CreateDriverRequest  # noqa: E501
from samsara.rest import ApiException

class TestCreateDriverRequest(unittest.TestCase):
    """CreateDriverRequest unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CreateDriverRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = samsara.models.create_driver_request.CreateDriverRequest()  # noqa: E501
        if include_optional :
