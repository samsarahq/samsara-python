...
import samsara
from samsara.models.list_addresses_response import ListAddressesResponse  # noqa: E501
...
class TestListAddressesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = samsara.models.list_addresses_response.ListAddressesResponse()  # noqa: E501
        if include_optional :
            return ListAddressesResponse(
                data = [
                    samsara.models.address.Address(
                        address_types = [
                            'yard'
                            ], 
                        contacts = [
