...
def test_betaApIs_get_driver_trailer_assignments() -> None:
    """Test getDriverTrailerAssignments endpoint with WireMock"""
    test_id = "beta_ap_is.get_driver_trailer_assignments.0"
    client = get_client(test_id)
    client.beta_ap_is.get_driver_trailer_assignments()
    verify_request_count(test_id, "GET", "/driver-trailer-assignments", None, 1)


def test_betaApIs_create_driver_trailer_assignment() -> None:
    """Test createDriverTrailerAssignment endpoint with WireMock"""
    test_id = "beta_ap_is.create_driver_trailer_assignment.0"
    client = get_client(test_id)
    client.beta_ap_is.create_driver_trailer_assignment(driver_id="494123", trailer_id="12345")
    verify_request_count(test_id, "POST", "/driver-trailer-assignments", None, 1)


def test_betaApIs_update_driver_trailer_assignment() -> None:
    """Test updateDriverTrailerAssignment endpoint with WireMock"""
    test_id = "beta_ap_is.update_driver_trailer_assignment.0"
    client = get_client(test_id)
    client.beta_ap_is.update_driver_trailer_assignment(id="id", end_time="2019-06-13T19:08:25Z")
    verify_request_count(test_id, "PATCH", "/driver-trailer-assignments", {"id": "id"}, 1)


def test_betaApIs_create_driver_auth_token() -> None:
    """Test createDriverAuthToken endpoint with WireMock"""
    test_id = "beta_ap_is.create_driver_auth_token.0"
    client = get_client(test_id)
    client.beta_ap_is.create_driver_auth_token(code="dp[gZc1wAigz4uGa0Hh")
    verify_request_count(test_id, "POST", "/fleet/drivers/create-auth-token", None, 1)
...
def test_betaApIs_get_safety_events_v_2() -> None:
    """Test getSafetyEventsV2 endpoint with WireMock"""
    test_id = "beta_ap_is.get_safety_events_v_2.0"
    client = get_client(test_id)
    client.beta_ap_is.get_safety_events_v_2()
    verify_request_count(test_id, "GET", "/safety-events", None, 1)


def test_betaApIs_get_safety_events_v_2_stream() -> None:
    """Test getSafetyEventsV2Stream endpoint with WireMock"""
    test_id = "beta_ap_is.get_safety_events_v_2_stream.0"
    client = get_client(test_id)
    client.beta_ap_is.get_safety_events_v_2_stream(start_time="startTime")
...
def test_betaApIs_get_trips() -> None:
    """Test getTrips endpoint with WireMock"""
    test_id = "beta_ap_is.get_trips.0"
    client = get_client(test_id)
    client.beta_ap_is.get_trips(start_time="startTime")
    verify_request_count(test_id, "GET", "/trips/stream", {"startTime": "startTime"}, 1)
