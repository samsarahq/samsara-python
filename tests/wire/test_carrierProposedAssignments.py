...
def test_carrierProposedAssignments_delete_carrier_proposed_assignment() -> None:
    """Test deleteCarrierProposedAssignment endpoint with WireMock"""
    test_id = "carrier_proposed_assignments.delete_carrier_proposed_assignment.0"
    client = get_client(test_id)
    client.carrier_proposed_assignments.delete_carrier_proposed_assignment(id="id")
