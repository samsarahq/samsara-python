...
def test_workOrders_post_invoice_scan() -> None:
    """Test postInvoiceScan endpoint with WireMock"""
    test_id = "work_orders.post_invoice_scan.0"
    client = get_client(test_id)
    client.work_orders.post_invoice_scan(
        file={"base_64_content": "JVBERi0xLjQKJeLjz9MKMyAwIG9iago8P...", "content_type": "application/pdf"}
    )
    verify_request_count(test_id, "POST", "/maintenance/invoice-scans", None, 1)
