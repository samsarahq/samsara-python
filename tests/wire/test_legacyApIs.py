...
def test_legacyApIs_get_safety_events() -> None:
    ...
    test_id = "legacy_ap_is.get_safety_events.0"
    client = get_client(test_id)
    client.legacy_ap_is.get_safety_events(start_time="startTime", end_time="endTime")
...
def test_legacyApIs_get_safety_activity_event_feed() -> None:
    ...
    test_id = "legacy_ap_is.get_safety_activity_event_feed.0"
    client = get_client(test_id)
...
def test_legacyApIs_v_1_get_vehicle_harsh_event() -> None:
    ...
    test_id = "legacy_ap_is.v_1_get_vehicle_harsh_event.0"
    client = get_client(test_id)
    client.legacy_ap_is.v_1_get_vehicle_harsh_event(vehicle_id=1000000, timestamp=1000000)
