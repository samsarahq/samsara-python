...
## Beta APIs
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">get_voice_sessions</a>(...) -&gt; AsyncHttpResponse[AgentStudioVoiceSessionsGetVoiceSessionsResponseBody]</code></summary>
<dl>
<dd>
...
**ids:** `typing.Optional[typing.Union[str, typing.Sequence[str]]]` — Required, comma-separated list of voice session IDs to fetch full details for. Up to 100 session IDs per call. IDs that are not found are omitted from the response.
...
**start_time:** `typing.Optional[dt.datetime]` — RFC 3339 timestamp. Returns transactions updated after this time. Compared against updatedAt. If not provided, returns all transactions. Millisecond precision and timezones are supported. (Examples: 2019-06-13T19:08:25Z, 2019-06-13T19:08:25.455Z, OR 2015-09-15T14:00:12-04:00).
...
**end_time:** `typing.Optional[dt.datetime]` — RFC 3339 timestamp. Returns transactions updated before this time. Compared against updatedAt. If not provided, behaves as an unending feed of changes. Millisecond precision and timezones are supported. (Examples: 2019-06-13T19:08:25Z, 2019-06-13T19:08:25.455Z, OR 2015-09-15T14:00:12-04:00).
...
**asset_ids:** `typing.Optional[typing.Union[str, typing.Sequence[str]]]` — Filter by asset IDs. Up to 50 ids.
...
**models:** `typing.Optional[typing.Union[str, typing.Sequence[str]]]` — Optional string of comma separated device models. Valid values: `CM31`, `CM32`, `CM33`, `CM34`, `VG34`, `VG34M`, `VG34EU`, `VG34FN`, `VG54NA`, `VG54EU`, `VG55NA`, `VG55EU`, `AG24`, `AG24EU`, `AG26`, `AG26EU`, `AG45`, `AG45EU`, `AG46`, `AG46EU`, `AG46P`, `AG46PEU`, `AG51`, `AG51EU`, `AG52`, `AG52EU`, `AG53`, `AG53EU`, `AT11`, `AT11X`, `AT12`, `AT12X`, `AT13`, `LM11`, `AIM4`, `AHD1`
...
**include_tags:** `typing.Optional[bool]` — Optional boolean to control whether tags are returned in the response. Defaults to false.
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">mark_asset_missing</a>(...) -&gt; AsyncHttpResponse[DeviceRecoveryMarkAssetMissingResponseBody]</code></summary>
<dl>
<dd>
...
**note:** `typing.Optional[str]` — Optional note when marking asset as missing.
...
**notification_recipients:** `typing.Optional[typing.Sequence[NotificationRecipientRequestBody]]` — List of users to notify when asset is marked as missing.
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">recover_asset</a>(...) -&gt; AsyncHttpResponse[DeviceRecoveryRecoverAssetResponseBody]</code></summary>
<dl>
<dd>
...
**missing_reason:** `DeviceRecoveryRecoverAssetRequestBodyMissingReason` — The reason the asset was marked as missing.  Valid values: `MISPLACED`, `STOLEN`, `NOT_SURE`
...
**recovery_status:** `DeviceRecoveryRecoverAssetRequestBodyRecoveryStatus` — Whether the asset has been physically recovered.  Valid values: `YES`, `NO`, `NOT_SURE`
...
**driver_name:** `str` — The full name of the driver to resolve.
...
**vehicle_id:** `str` — The vehicle ID. This can be either a unique Samsara ID or an external ID for the vehicle.
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">post_driver_workflow_assignment</a>(...) -&gt; AsyncHttpResponse[
...
**workflow_id:** `str` — The UUID of the workflow to publish.
...
**driver_ids_to_publish:** `typing.Optional[typing.Sequence[str]]` — List of driver IDs to publish the workflow to. If a driver already has the workflow, the operation is a no-op for that driver.
...
**driver_ids_to_unpublish:** `typing.Optional[typing.Sequence[str]]` — List of driver IDs to unpublish the workflow from. If a driver does not have the workflow, the operation is a no-op for that driver.
...
**ids:** `typing.Optional[typing.Union[str, typing.Sequence[str]]]` — A comma-separated list of up to 100 vendor IDs to filter on. Accepts Samsara UUIDs or external IDs in key:value format. See [external IDs](https://developers.samsara.com/docs/external-ids).
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">post_tachograph_file_upload</a>(...) -&gt; AsyncHttpResponse[TachographFileUploadsPostTachographFileUploadResponseBody]</code></summary>
<dl>
<dd>
...
**file_size_bytes:** `int` — The size of the file in bytes. Enforced as the Content-Length on upload. Maximum 10 MB (10485760 bytes).
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">create_function</a>(...) -&gt; AsyncHttpResponse[FunctionsCreateFunctionResponseBody]</code></summary>
<dl>
<dd>
...
**name:** `str` — Unique name for the Function.
...
**description:** `typing.Optional[str]` — A description of the Function.
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">get_function_storage_file</a>(...) -&gt; AsyncHttpResponse[FunctionsStorageGetFunctionStorageFileResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">create_function_storage_file</a>(...) -&gt; AsyncHttpResponse[FunctionsStorageCreateFunctionStorageFileResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">update_function_storage_file</a>(...) -&gt; AsyncHttpResponse[FunctionsStorageUpdateFunctionStorageFileResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">delete_function_storage_file</a>(...) -&gt; AsyncHttpResponse[None]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">list_functions_storage_files</a>(...) -&gt; AsyncHttpResponse[FunctionsStorageListFunctionsStorageFilesResponseBody]</code></summary>
<dl>
<dd>
...
**limit:** `typing.Optional[int]` — The maximum number of files to return per page.
...
**include_download_urls:** `typing.Optional[bool]` — If true, include presigned download URLs for each file.
...
**include_upload_urls:** `typing.Optional[bool]` — If true, include presigned upload URLs for each file. Requires write permission.
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">get_function</a>(...) -&gt; AsyncHttpResponse[FunctionsGetFunctionResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">delete_function</a>(...) -&gt; AsyncHttpResponse[None]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">patch_function</a>(...) -&gt; AsyncHttpResponse[FunctionsPatchFunctionResponseBody]</code></summary>
<dl>
<dd>
...
**last_update_timestamp_ms:** `int` — Timestamp of the last known update to this Function, obtained from a create or get response. Required to prevent conflicting updates.
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">deploy_function</a>(...) -&gt; AsyncHttpResponse[FunctionsDeployFunctionResponseBody]</code></summary>
<dl>
<dd>
...
**name:** `str` — The name of the Function to deploy.
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">get_function_logs</a>(...) -&gt; AsyncHttpResponse[FunctionsGetFunctionLogsResponseBody]</code></summary>
<dl>
<dd>
...
**name:** `str` — The name of the Function whose logs to retrieve.
...
**start_time:** `dt.datetime` — Required RFC 3339 timestamp for the beginning of the log time range.
...
**end_time:** `dt.datetime` — Required RFC 3339 timestamp for the end of the log time range.
...
**limit:** `typing.Optional[int]` — The maximum number of log entries to return per page. Default is 100.
...
**filter_text:** `typing.Optional[str]` — Optional text to filter log entries. Only logs containing this text will be returned.
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">pair_gateways</a>(...) -&gt; AsyncHttpResponse[GatewaysPairGatewaysResponseBody]</code></summary>
<dl>
<dd>
...
**pairs:** `typing.Sequence[PairGatewayPairObjectRequestBody]` — Gateway-device pairs to apply.
...
**order_ids:** `typing.Optional[str]` — Comma-separated list of order IDs for filtering.
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">delete_plan_orders</a>(...) -&gt; AsyncHttpResponse[None]</code></summary>
<dl>
<dd>
...
**order_ids:** `typing.Optional[str]` — Comma-separated list of order IDs to delete. Mutually exclusive with `deleteAll=true`; exactly one of the two must be provided.
...
**delete_all:** `typing.Optional[bool]` — When `true`, every order in the plan is deleted. Must not be combined with `orderIds`. Must be set to `true` explicitly — `false` is equivalent to omitting the parameter and requires `orderIds` to be supplied.
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">list_hub_route_templates</a>(...) -&gt; AsyncHttpResponse[HubRouteTemplatesListHubRouteTemplatesResponseBody]</code></summary>
<dl>
<dd>
...
**id:** `typing.Optional[str]` — Filter by a specific route template ID.
...
**name:** `typing.Optional[str]` — Filter by route template name (exact match).
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">get_work_order_templates</a>(...) -&gt; AsyncHttpResponse[WorkOrdersGetWorkOrderTemplatesResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">get_places</a>(...) -&gt; AsyncHttpResponse[PlacesGetPlacesResponseBody]</code></summary>
<dl>
<dd>
...
**include_tags:** `typing.Optional[bool]` — When true, expands tag objects on each place. Defaults to false.
...
**include_external_ids:** `typing.Optional[bool]` — When true, includes externalIds on each place. Defaults to false.
...
**tag_ids:** `typing.Optional[str]` — Comma-separated numeric tag IDs to filter places.
...
**place_types:** `typing.Optional[str]` — Comma-separated place type tokens (e.g. yard,normalGeofence).
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">post_place</a>(...) -&gt; AsyncHttpResponse[PlacesPostPlaceResponseBody]</code></summary>
<dl>
<dd>
...
**notes:** `typing.Optional[str]` — Optional notes.
...
**tags:** `typing.Optional[typing.Sequence[PostPlaceTagRefRequestBody]]` — Tags to associate.
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">delete_place</a>(...) -&gt; AsyncHttpResponse[None]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">patch_place</a>(...) -&gt; AsyncHttpResponse[PlacesPatchPlaceResponseBody]</code></summary>
<dl>
<dd>
...
**name:** `typing.Optional[str]` — Place name.
...
**notes:** `typing.Optional[str]` — Notes.
...
**tags:** `typing.Optional[typing.Sequence[PostPlaceTagRefRequestBody]]` — When present, replaces all tag associations for the place.
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">get_place_deletions</a>(...) -&gt; AsyncHttpResponse[PlacesGetPlaceDeletionsResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">get_place_geocode</a>(...) -&gt; AsyncHttpResponse[PlacesGetPlaceGeocodeResponseBody]</code></summary>
<dl>
<dd>
...
client.beta_ap_is.get_place_geocode(
    address="address",
)
...
**address:** `str` — Address string to forward-geocode (URL-encoded). Required; must be non-empty.
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">get_report_configs</a>(...) -&gt; AsyncHttpResponse[ReportsGetReportConfigsResponseBody]</code></summary>
<dl>
<dd>
...
**limit:** `typing.Optional[int]` — Maximum number of configs to return
...
**ids:** `typing.Optional[typing.Union[str, typing.Sequence[str]]]` — The list of report config IDs to retrieve. Include up to 10 report config IDs. If not provided, all configs will be returned.
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">get_datasets</a>(...) -&gt; AsyncHttpResponse[ReportsGetDatasetsResponseBody]</code></summary>
<dl>
<dd>
...
**ids:** `typing.Optional[typing.Union[str, typing.Sequence[str]]]` — The list of dataset IDs to retrieve the datasets for. Include up to 10 dataset IDs. If not provided, all datasets will be returned.
...
**limit:** `typing.Optional[int]` — Maximum number of datasets to return.
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">get_report_runs</a>(...) -&gt; AsyncHttpResponse[ReportsGetReportRunsResponseBody]</code></summary>
<dl>
<dd>
...
**report_config_ids:** `typing.Optional[typing.Union[str, typing.Sequence[str]]]` — The list of report config IDs to retrieve the report runs for. Include up to 10 report config IDs. If not provided, runs for all configs will be returned.
...
**ids:** `typing.Optional[typing.Union[str, typing.Sequence[str]]]` — The list of report run IDs to retrieve the report runs for. Include up to 10 report run IDs. If not provided, all report runs will be returned.
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">create_report_run</a>(...) -&gt; AsyncHttpResponse[ReportsCreateReportRunResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">get_report_run_data</a>(...) -&gt; AsyncHttpResponse[ReportsGetReportRunDataResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">list_ridership_passengers</a>(...) -&gt; AsyncHttpResponse[RidershipPassengersListRidershipPassengersResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">create_ridership_passenger</a>(...) -&gt; AsyncHttpResponse[RidershipPassengersCreateRidershipPassengerResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">update_ridership_passenger</a>(...) -&gt; AsyncHttpResponse[RidershipPassengersUpdateRidershipPassengerResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">delete_ridership_passenger</a>(...) -&gt; AsyncHttpResponse[None]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">get_ridership_passenger</a>(...) -&gt; AsyncHttpResponse[RidershipPassengersGetRidershipPassengerResponseBody]</code></summary>
<dl>
<dd>
...
**route_id:** `str` — The Samsara route ID returned by the Routing API, or an external ID in `key:value` format. For example, `extRoute:WB-12`.
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">update_ridership_route_setup</a>(...) -&gt; AsyncHttpResponse[RidershipRouteSetupsUpdateRidershipRouteSetupResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">delete_ridership_route_setup</a>(...) -&gt; AsyncHttpResponse[None]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">get_ridership_route_setup</a>(...) -&gt; AsyncHttpResponse[RidershipRouteSetupsGetRidershipRouteSetupResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.beta_ap_is.<a href="src/samsara/beta_ap_is/client.py">patch_safety_events_v_2_batch</a>(...) -&gt; AsyncHttpResponse[SafetyEventsV2PatchSafetyEventsV2BatchResponseBody]</code></summary>
<dl>
<dd>
...
**include_reverse_geo:** `typing.Optional[bool]` — Optional boolean indicating whether or not to return the 'address' object. Address information won't be returned for high-frequency locations.
...
**include_high_frequency_locations:** `typing.Optional[bool]` — Optional boolean indicating whether or not to return high-frequency location data (up to 1Hz). Cannot be used with includeGeofenceLookup.
...
**end_time:** `str` — An end time in RFC 3339 format. If endTime is the same as startTime, an image will be captured at startTime. Must be 1 second or more after startTime and no more than the maximum allowed duration per video retrieval type. Please refer to our KB articles for more information. (Examples: 2019-06-13T19:08:55Z, 2019-06-13T19:08:55.455Z, OR 2015-09-15T14:00:42-04:00).
...
<details><summary><code>client.driver_trailer_assignments.<a href="src/samsara/driver_trailer_assignments/client.py">get_driver_trailer_assignments</a>(...) -&gt; AsyncHttpResponse[TrailerAssignmentsGetDriverTrailerAssignmentsResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.driver_trailer_assignments.<a href="src/samsara/driver_trailer_assignments/client.py">create_driver_trailer_assignment</a>(...) -&gt; AsyncHttpResponse[TrailerAssignmentsCreateDriverTrailerAssignmentResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.driver_trailer_assignments.<a href="src/samsara/driver_trailer_assignments/client.py">update_driver_trailer_assignment</a>(...) -&gt; AsyncHttpResponse[TrailerAssignmentsUpdateDriverTrailerAssignmentResponseBody]</code></summary>
<dl>
<dd>
...
**driver_activation_status:** `typing.Optional[ListDriversRequestDriverActivationStatus]` — If value is `deactivated`, only drivers that are deactivated will appear in the response. This parameter will default to `active` if not provided (fetching only active drivers).
...
**trailer_group_tag_id:** `typing.Optional[str]` — Tag ID which determines which trailers a driver will see when selecting trailers.
...
## AuthTokenForDriver
<details><summary><code>client.auth_token_for_driver.<a href="src/samsara/auth_token_for_driver/client.py">auth_token</a>(...) -&gt; AsyncHttpResponse[AuthTokenAuthTokenResponseBody]</code></summary>
<dl>
<dd>
...
**driver_id:** `typing.Optional[int]` — Optional. Samsara ID of the driver. One of `id`, `externalId`, or `username` is required.
...
**include:** `typing.Optional[typing.Union[str, typing.Sequence[str]]]` — A comma-separated list of additional fields to include in the response. Valid values: `stops.actualDistanceMeters`
...
<details><summary><code>client.trailers.<a href="src/samsara/trailers/client.py">get_trailer_stats_snapshot</a>(...) -&gt; AsyncHttpResponse[TrailerStatsGetTrailerStatsSnapshotResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.trailers.<a href="src/samsara/trailers/client.py">get_trailer_stats_feed</a>(...) -&gt; AsyncHttpResponse[TrailerStatsGetTrailerStatsFeedResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.trailers.<a href="src/samsara/trailers/client.py">get_trailer_stats_history</a>(...) -&gt; AsyncHttpResponse[TrailerStatsGetTrailerStatsHistoryResponseBody]</code></summary>
<dl>
<dd>
...
**session_configuration_id:** `typing.Optional[str]` — The ID of a saved session configuration (preset) to apply when creating the plan. When provided, the preset's optimization settings and route constructions are applied to the new plan, replacing any defaults.
...
**values:** `typing.Dict[str, typing.Any]` — A map of data output IDs to values. All data outputs must belong to the same asset. Only the specified IDs will be written to.
...
## WorkOrders
<details><summary><code>client.work_orders.<a href="src/samsara/work_orders/client.py">post_invoice_scan</a>(...) -&gt; AsyncHttpResponse[WorkOrdersPostInvoiceScanResponseBody]</code></summary>
<dl>
<dd>
...
**asset_id:** `typing.Optional[str]` — Asset ID to create a new work order for the invoice. Provide either workOrderId OR assetId, but not both. If assetId is provided, a new work order will be created for that asset. If workOrderId is provided instead, the invoice will be attached to the existing work order.
...
**work_order_id:** `typing.Optional[str]` — Work order ID to attach the invoice to an existing work order. Provide either workOrderId OR assetId, but not both. If workOrderId is provided, the invoice will be attached to the existing work order. If assetId is provided instead, a new work order will be created for that asset.
...
**category:** `typing.Optional[str]` — The category of the work order
...
**entity_types:** `typing.Optional[str]` — A list of entity types to return readings for. (Examples: asset, sensor)
...
<details><summary><code>client.readings.<a href="src/samsara/readings/client.py">get_readings_history</a>(...) -&gt; AsyncHttpResponse[ReadingsGetReadingsHistoryResponseBody]</code></summary>
<dl>
<dd>
...
**entity_type:** `str` — The entity type of the entityIds or externalIds to fetch readings for. Use /readings/definitions endpoint to get a list of valid entity types. (Examples: asset, sensor)
...
**entity_ids:** `typing.Optional[str]` — A filter on the data based on this comma-separated list of entity IDs. If not set, all entities are returned.
...
**start_time:** `typing.Optional[str]` — A filter on the data that returns data points with timestamps greater than or equal to this value. Required when feed mode is not enabled. Must be a string in RFC 3339 format. Millisecond precision and timezones are supported. (Examples: 2020-01-27T07:06:25Z)
...
<details><summary><code>client.readings.<a href="src/samsara/readings/client.py">get_readings_snapshot</a>(...) -&gt; AsyncHttpResponse[ReadingsGetReadingsSnapshotResponseBody]</code></summary>
<dl>
<dd>
...
## Safety
<details><summary><code>client.safety.<a href="src/samsara/safety/client.py">get_safety_events_v_2</a>(...) -&gt; AsyncHttpResponse[SafetyEventsV2GetSafetyEventsV2ResponseBody]</code></summary>
<dl>
<dd>
...
**include_vg_only_events:** `typing.Optional[bool]` — Indicates whether or not to return events that are captured by devices with only a Vehicle Gateway (VG) installed.
...
<details><summary><code>client.safety.<a href="src/samsara/safety/client.py">get_safety_events_v_2_stream</a>(...) -&gt; AsyncHttpResponse[SafetyEventsV2GetSafetyEventsV2StreamResponseBody]</code></summary>
<dl>
<dd>
...
## SafetyScores
<details><summary><code>client.safety_scores.<a href="src/samsara/safety_scores/client.py">get_driver_safety_scores</a>(...) -&gt; AsyncHttpResponse[SafetyScoresGetDriverSafetyScoresResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.safety_scores.<a href="src/samsara/safety_scores/client.py">get_tag_group_safety_scores</a>(...) -&gt; AsyncHttpResponse[SafetyScoresGetTagGroupSafetyScoresResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.safety_scores.<a href="src/samsara/safety_scores/client.py">get_tag_safety_scores</a>(...) -&gt; AsyncHttpResponse[SafetyScoresGetTagSafetyScoresResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.safety_scores.<a href="src/samsara/safety_scores/client.py">get_vehicle_safety_scores</a>(...) -&gt; AsyncHttpResponse[SafetyScoresGetVehicleSafetyScoresResponseBody]</code></summary>
<dl>
<dd>
...
## TrainingAssignments
<details><summary><code>client.training_assignments.<a href="src/samsara/training_assignments/client.py">post_training_assignments</a>(...) -&gt; AsyncHttpResponse[TrainingAssignmentsPostTrainingAssignmentsResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.training_assignments.<a href="src/samsara/training_assignments/client.py">delete_training_assignments</a>(...) -&gt; AsyncHttpResponse[None]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.training_assignments.<a href="src/samsara/training_assignments/client.py">patch_training_assignments</a>(...) -&gt; AsyncHttpResponse[TrainingAssignmentsPatchTrainingAssignmentsResponseBody]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.training_assignments.<a href="src/samsara/training_assignments/client.py">get_training_assignments_stream</a>(...) -&gt; AsyncHttpResponse[TrainingAssignmentsGetTrainingAssignmentsStreamResponseBody]</code></summary>
<dl>
<dd>
...
**is_overdue:** `typing.Optional[bool]` — Optional boolean value. If present, training assignments for the specified overdue status will be returned. Valid values: true, false. Defaults to returning all assignments.
...
**category_ids:** `typing.Optional[typing.Union[str, typing.Sequence[str]]]` — Optional string of comma separated category IDs. If category ID is present, training assignments for the specified category ID(s) will be returned. Max value for this value is 100 objects. Example: `categoryIds=a4db8702-79d5-4396-a717-e301d52ecc11,c6490f6a-d84e-49b5-b0ad-b6baae304075`
...
## TrainingCourses
<details><summary><code>client.training_courses.<a href="src/samsara/training_courses/client.py">get_training_courses</a>(...) -&gt; AsyncHttpResponse[TrainingCoursesGetTrainingCoursesResponseBody]</code></summary>
<dl>
<dd>
...
## Trips
<details><summary><code>client.trips.<a href="src/samsara/trips/client.py">get_trips</a>(...) -&gt; AsyncHttpResponse[TripsGetTripsResponseBody]</code></summary>
<dl>
<dd>
